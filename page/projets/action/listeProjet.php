...
<a href="./?s=projets&project=<?= $projet["id"] ?>">
    <div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        ...
        <div class="rounded overflow-hidden shadow-lg flex flex-col">
            <a href="./?s=projets&project=<?= $projet["id"] ?>"></a>
            ...
            <div class="px-6 py-4 mb-auto">
                <a href="./?s=projets&project=<?= $projet["id"] ?>" class="font-medium text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2"><?= $projet["intro"] ?></a>
            ...
            <div class="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                ...
                <span href="./?s=projets&project=<?= $projet["id"] ?>" class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
